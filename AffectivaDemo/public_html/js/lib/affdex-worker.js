...
function genderStr(g) {
    var ret = '';
    if (Module.Gender) {
        if (g.value == Module.Gender.Female.value)
            ret = "Female";
        else if (g.value == Module.Gender.Male.value)
            ret = "Male";
        else if (g.value == Module.Gender.Unknown.value)
            ret = "Unknown";
    }
    return ret;
}
...
function ethnicityStr(g) {
    var ret = '';
    if (Module.Ethnicity) {
        if (g.value == Module.Ethnicity.CAUCASIAN.value)
            ret = "Caucasian";
        else if (g.value == Module.Ethnicity.BLACK_AFRICAN.value)
            ret = "Black African";
        else if (g.value == Module.Ethnicity.SOUTH_ASIAN.value)
            ret = "South Asian";
        else if (g.value == Module.Ethnicity.EAST_ASIAN.value)
            ret = "East Asian";
        else if (g.value == Module.Ethnicity.HISPANIC.value)
            ret = "Hispanic";
        else if (g.value == Module.Ethnicity.UNKNOWN.value)
            ret = "Unknown";
    }
    return ret;
}
...
function ageStr(g) {
    var ret = '';
    if (Module.Age) {
        if (g.value == Module.Age.AGE_UNKNOWN.value)
            ret = "Unknown";
        else if (g.value == Module.Age.AGE_UNDER_18.value)
            ret = "Under 18";
        else if (g.value == Module.Age.AGE_18_24.value)
            ret = "18 - 24";
        else if (g.value == Module.Age.AGE_25_34.value)
            ret = "25 - 34";
        else if (g.value == Module.Age.AGE_35_44.value)
            ret = "35 - 44";
        else if (g.value == Module.Age.AGE_45_54.value)
            ret = "45 - 54";
        else if (g.value == Module.Age.AGE_55_64.value)
            ret = "55 - 64";
        else if (g.value == Module.Age.AGE_65_PLUS.value)
            ret = "65+";
    }
    return ret;
}
...
function glassesStr(g) {
    var ret = '';
    if (Module.Glasses) {
        if (g.value == Module.Glasses.No.value)
            ret = "No";
        else if (g.value == Module.Glasses.Yes.value)
            ret = "Yes";
    }
    return ret;
}